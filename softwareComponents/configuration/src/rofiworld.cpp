...
RofiWorld::RoficomJointHandle connect( const Component& c1, const Component& c2, roficom::Orientation o ) {
    ...
    RofiWorld& bot = *c1.parent->parent;
    RofiWorld::ModuleInfo& m1info = bot._modules[ bot._idMapping[ c1.parent->getId() ] ];
    RofiWorld::ModuleInfo& m2info = bot._modules[ bot._idMapping[ c2.parent->getId() ] ];
